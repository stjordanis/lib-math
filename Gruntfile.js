module.exports = function(grunt) {
  ...
  grunt.initConfig({
    ...
    watch:{
      main1:{files:['example.q','math.q'],tasks:['qshell:main1'],options:{spawn:false,atBegin:true,interrupt:true}},
      main2:{files:['example2.q','math.q'],tasks:['qshell:main2'],options:{spawn:false,atBegin:true,interrupt:true}},
      test1:{files:['test/main.q','math.q'],tasks:['qshell:test1'],options:{spawn:false,atBegin:true,interrupt:true}}
